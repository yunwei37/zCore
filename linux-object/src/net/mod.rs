...
struct SmoltcpBase<D: for<'d> Device<'d>> {
    iface: EthernetInterface<'static, 'static, 'static, D>,
...
impl<D: for<'d> Device<'d>> SmoltcpBase<D> {
    ...
    fn get<T: AnySocket<'static, 'static>>(&mut self, handle: SocketHandle) -> SocketRef<T> {
...
fn get_ephemeral_port() -> u16 {
    ...
    unsafe {
        if EPHEMERAL_PORT == 0 {
            EPHEMERAL_PORT = (49152 + crate::util::rand() % (65536 - 49152)) as u16;
        }
